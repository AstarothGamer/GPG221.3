...
public class BuildingsGeneralManager : MonoBehaviour
{
    ...
    public bool CanAfford(WorldState ws, BuildingType t)   //Are there enough resources in the warehouse for the specified recipe
    {
        var r = GetRecipe(t);
    ...
    public bool WithdrawToBackpack(WorldState ws, LocalState ls, BuildingType t)    //Transfer recipe cost from storage to unit's backpack
    {
    ...
    public void ConsumeBackpackFor(LocalState ls, BuildingType t)   //Delete recipe cost from backpack after successful construction
    {
